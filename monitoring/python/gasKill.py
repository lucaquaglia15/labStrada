...
async def main():
    ...
    while True:
        ...
        if delta > 60: #1200 s = logger stopped for more than 20 minutes
            ...
            await bot.send_photo(photo="http://localhost:3000/render/d-solo/3-C8udEVk/labstrada?orgId=1&refresh=5s&from=1685020671325&to=1685020971325&panelId=5&width=1000&height=500&tz=Europe%2FRome", chat_id=-1001902276824)
            #await bot.send_document(chat_id=-1001902276824, document='http://localhost:3000/d/3-C8udEVk/labstrada?orgId=1&from=now-1h&to=now&refresh=5s&viewPanel=5')
